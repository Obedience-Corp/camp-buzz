...
go_image="${CAMP_BUZZ_GO_IMAGE:-golang:1.25.8-bookworm}"
gitleaks_image="${CAMP_BUZZ_GITLEAKS_IMAGE:-zricethezav/gitleaks:v8.28.0}"
goreleaser_image="${CAMP_BUZZ_GORELEASER_IMAGE:-goreleaser/goreleaser:v2.15.2}"
